...
export default function LoginStudent() {
  ...
  return (
    <div
      data-theme="light"
      className="bg-[url('https://a.cdn-hotels.com/gdcs/production122/d1368/1ecd1184-2b25-4fa6-877c-320dc8a0f1e5.jpg?impolicy=fcrop&w=1600&h=1066&q=medium')] flex justify-center h-[100vh] items-center bg-cover bg-center"
    >
          ...
          <div className="p-4 w-full">
            <form className="flex flex-col select-none  " onSubmit={hdlSubmit}>
              <div className="flex flex-col gap-2">
                <img
                  className="mx-auto rounded-full w-[120px] h-[120px] pointer-events-none"
                  src="/Blue and Pink Simple School Logo.png"
                />
                <h1 className="text-2xl text-center font-extrabold text-white drop-shadow-[2px_2px_1.5px_rgba(0,0,0,0.25)]">
                  Login
                </h1>
                <label className="text-white font-semibold">Username</label>
                <input
                  className={`h-[2.5rem] border-2 rounded-full px-5 focus:outline-[#6096B4] ${
                    input.username === ""
                      ? "border-[#FF90BC]"
                      : "border-[#6096B4]"
                  }`}
              ...
              <div className="flex justify-between mt-3">
                ...
                <input
                  type="submit"
                  className="bg-white font-semibold px-8 scale-100 active:scale-95 hover:bg-green-700 hover:text-white rounded-full"
                  value="Login"
                />
              </div>
            </form>
