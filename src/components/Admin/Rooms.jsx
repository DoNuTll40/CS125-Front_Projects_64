...
export default function Rooms() {
    ...
    useEffect(() => {
        document.title = 'Admin | รายชื่อห้องเรียน';
            ...
            <div className='max-w-[80rem] mx-auto mt-3 select-none'>
                <div className='bg-white p-5 rounded-2xl max-w-[53rem] mt-5 mx-auto'>
                    <div className='flex justify-end'>
                        <button className='bg-[#FF90BC] font-semibold transition-all ease-in-out duration-150 hover:bg-[#6096B4] border-2 border-white text-white shadow-md py-2 px-3 rounded-lg' onClick={() => navigate('add')} type="button">เพิ่มห้องเรียน</button>
                    </div>
